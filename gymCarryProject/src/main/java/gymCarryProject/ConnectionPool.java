...
public final class ConnectionPool {
 ...
 // Storage for the allocated connections.
     ...
     * @param	  maxCons	The maximum idber of connections allowed.
...
throws SQLException {
  ...
  if (free.isEmpty()) {
	 ...
	 * is empty but idCons is now < maxCons and we can create a
	 * new connection.
	 */
	if (maxCons <= 0 || idCons < maxCons) {
	  addConnection();
...
return con;
     ...
     * The maxCons values specifies the maximum idber of
